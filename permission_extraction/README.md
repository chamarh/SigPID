- ‘attachTrain 22_benign.py’ is a python file that permits to extract the 22 significant permissions from benign applications and has as output a CSV file that stores the extracted features.
